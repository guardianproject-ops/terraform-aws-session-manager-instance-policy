...
# terraform-aws-session-manager-instance-policy
...
Instead pin to the release tag (e.g. `?ref=tags/x.y.z`) of one of our [latest releases](https://gitlab.com/guardianproject-ops/terraform-aws-session-manager-instance-policy/releases).



```hcl
module "session_manager_instance_policy" {
  source          = "git::https://gitlab.com/guardianproject-ops/terraform-aws-session-manager-instance-policy?ref=tags/0.1.0"
...
Like this project? Please give it a ★ on [GitLab](https://gitlab.com/guardianproject-ops/terraform-aws-session-manager-instance-policy)
...
- [terraform-aws-ssm-ansible-setup](https://gitlab.com/guardianproject-ops/terraform-aws-ssm-ansible-setup) - Terraform module that creates the s3 bucket and policies for session manager
...
File an [issue](https://gitlab.com/guardianproject-ops/terraform-aws-session-manager-instance-policy/issues), send us an [email][email] or join us in the Matrix 'verse at [#guardianproject:matrix.org][matrix] or IRC at `#guardianproject` on Freenode.

## Contributing

### Bug Reports & Feature Requests

Please use the [issue tracker](https://gitlab.com/guardianproject-ops/terraform-aws-session-manager-instance-policy/issues) to report any bugs or file feature requests.
